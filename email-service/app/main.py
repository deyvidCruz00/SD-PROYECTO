...
app = FastAPI(
    title="Email Service",
    description="Servicio de email para el sistema de proyectos colaborativos",
    version="1.0.0"
)
...
def start_kafka_consumer():
    ...
    try:
        ...
        def process_message(message):
            ...
            # Ejecutar la corutina de forma síncrona
            loop = asyncio.new_event_loop()
            asyncio.set_event_loop(loop)
            loop.run_until_complete(email_service.process_kafka_event(message))
